...
// @ts-ignore
import * as ImageEditor from 'tui-image-editor-kdoc';
// @ts-ignore
import * as tuiImageEditor from 'tui-image-editor-kdoc';

import 'tui-image-editor-kdoc/dist/svg/icon-a.svg';
import 'tui-image-editor-kdoc/dist/svg/icon-b.svg';
import 'tui-image-editor-kdoc/dist/svg/icon-c.svg';
import 'tui-image-editor-kdoc/dist/svg/icon-d.svg';
...
@Component({
  selector: 'tui-image-editor-kdoc',
  template: `
    <div #imageEditor></div>
  `,
  styleUrls: [
    '../../node_modules/tui-color-picker/dist/tui-color-picker.css',
    '../../node_modules/tui-image-editor-kdoc/dist/tui-image-editor-kdoc.css'
  ],
